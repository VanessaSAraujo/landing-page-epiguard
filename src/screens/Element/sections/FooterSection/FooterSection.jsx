  ...
  return (
    <footer className="w-full bg-transparent relative">
      <div className="relative w-full">
        ...
        <div className="w-full h-[0.3rem] absolute top-0 left-0 bg-[#03a650]" />

        {/* Logo */}
        <img
          className="absolute w-[15.5rem] h-[9rem] top-[1.1rem] left-1/2 -translate-x-1/2 object-cover"
          alt="EPIGUARD logo"
          src="https://c.animaapp.com/mbx4o6k4UxAFO0/img/design-studio-logo-1-1.svg"
        />

        {/* Social Media Icons */}
        <div className="flex items-end gap-[3vw] absolute top-[12rem] left-1/2 -translate-x-1/2">
        ...
        {/* Navigation Links */}
        <div className="hidden custom:flex justify-center gap-[6vw] absolute top-[270px] left-1/2 -translate-x-1/2 w-full">
        ...
        {/* Copyright Section */}
        <div className="absolute w-full bottom-[2rem] left-1/2 -translate-x-1/2 px-[8vw]">
