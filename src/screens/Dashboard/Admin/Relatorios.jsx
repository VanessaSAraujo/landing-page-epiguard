...
const relatorios = [
  ...
  {
    titulo: 'Relatório de Benchmarking Entre Obras',
    descricao: 'Compara indicadores de conformidade entre diferentes obras.',
    img: capaCard,
  },
  {
...
export default function Relatorios() {
  ...
  const handleDownload = (relatorio) => {
    ...
    alert(`Download do relatório: ${relatorio.titulo} (simulado)`);
    // Exemplo de integração futura:
    // fetch(`/api/relatorios/${relatorio.id}/download`)
    //   .then(...)
  };
