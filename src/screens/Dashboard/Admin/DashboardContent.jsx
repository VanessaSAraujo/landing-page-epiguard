...
const DashboardContent = ({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      {/* Card: Obras/Setores com mais infrações */}
      <div className="bg-white p-6 rounded-lg shadow lg:col-span-2">
        <h2 className="text-gray-600 font-semibold mb-4">{infractionsTitle}</h2>
        <div className="relative h-64">
          <Bar data={infractionsByWork?.barChartData || { labels: [], datasets: [] }} options={barChartOptions} />
        </div>
      </div>
